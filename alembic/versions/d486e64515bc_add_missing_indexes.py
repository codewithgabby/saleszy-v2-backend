...
def downgrade() -> None:
    indexes_to_drop = [
        ("ix_selling_units_product_id", "selling_units"),
        ("ix_selling_units_name", "selling_units"),
        ("ix_selling_units_barcode", "selling_units"),
        ("ix_selling_units_sku", "selling_units"),
        ("ix_selling_units_display_order", "selling_units"),
        ("ix_stock_movements_product_id", "stock_movements"),
        ("ix_stock_movements_movement_type", "stock_movements"),
        ("ix_stock_movements_reference", "stock_movements"),
    ]
